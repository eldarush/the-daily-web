...
// Persistent session middleware (connect-mongo)
app.use(createSessionMiddleware());

// Global view context injection (currentUser, current path)
...
// Web Routes: Modular placeholders for teammates
app.get('/', (req, res) => {
  res.render('pages/home', {
    title: 'The Daily Web — Breaking News',
    articles: []
  });
});
